"""
Django settings for social_project_06 project.
...
SECRET_KEY = "django-insecure-3%dh)kzd07(g94g^!igf(=_z(hyo$m%)vusfaqj%ok(p64rg=b"
...
ROOT_URLCONF = "social_project_06.urls"
...
WSGI_APPLICATION = "social_project_06.wsgi.application"
